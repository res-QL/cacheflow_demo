    ...
    return (
      <div id='introParent'>
        <div className='centerText'>
          ...
          <div>
            <a
              href='https://medium.com/@ian_73557/the-cacheflowql-library-is-a-lightweight-middleware-package-that-allows-smart-caching-on-graphql-3c5a061d8b35'
              target='_blank'
            >
              <button id='MediumArticleText'>Read our Medium Article</button>
            </a>
          </div>
        </div>
      </div>
